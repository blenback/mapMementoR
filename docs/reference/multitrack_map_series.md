...
#> Error in multitrack_map_series(output_dir = "outputs", styles = c("Dark",     "Emerald"), custom_styles = list(MyStyle = list(route_color = "#123456",     ...)), track_sets_path = "data-raw/track_sets.yaml", dpi = 300,     page_size = "A4", base_size = 12, orientation = "portrait",     with_elevation = TRUE, with_labels = FALSE, with_OSM = TRUE,     with_hillshade = FALSE, cache_data = TRUE, components = c("highways",         "streets", "water", "coast")): could not find function "multitrack_map_series"
```
