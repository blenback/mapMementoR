...
- [`create_race_map()`](blenback.github.io/mapMementoR/reference/create_race_map.md)
...
- [`get_osm_components()`](blenback.github.io/mapMementoR/reference/get_osm_components.md)
  : Get OSM map components (highways, streets, water, sea) for a
  bounding box and location
- [`get_page_dimensions()`](blenback.github.io/mapMementoR/reference/get_page_dimensions.md)
  : Returns width and height in mm for common page sizes
- [`get_track_stats()`](blenback.github.io/mapMementoR/reference/get_track_stats.md)
